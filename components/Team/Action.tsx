...
const TeamAction: FC<TeamAction> = ({ className }) => (
	<div className={classnames.merge([className])}>
		<div className="flex flex-col items-center justify-center space-y-4 space-x-0 lg:flex-row lg:space-y-0 lg:space-x-4">
			<a
				href="/contact"
				target="_blank"
				rel="noopener noreferrer"
				className={classnames.merge([
					'inline-block w-full font-manrope font-manrope md:w-auto',
			...
			<a
				...
				target="_blank"
				className={classnames.merge([
					'inline-block w-full font-manrope md:w-auto',
