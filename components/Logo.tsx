...
export const LogoIcon: FC<Logo> = ({ width, height, className }) => (
	<div className={classnames.merge([className, 'cursor-pointer md:w-auto'])}>
		<svg
			id="logo"
			width={width}
			height={height}
		...
		>
			...
			<rect
				...
				fill="currentColor"
			/>
			<rect x="18.3335" width="4" height="16" rx="2" fill="currentColor" />
			<rect
				x="24.3335"
				y="8"
				width="4"
